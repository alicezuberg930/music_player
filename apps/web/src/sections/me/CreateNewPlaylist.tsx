    ...
    <DialogContent className="sm:max-w-md">
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-4">
          <RHFTextField
            name="title"
            fieldLabel={translate("title")}
            placeholder={translate("enter_playlist_title")}
          />
          <RHFTextField
            name="description"
            fieldLabel={translate("description")}
            placeholder={translate("enter_playlist_description")}
          />
          <RHFSwitch
            name="isPrivate"
            label={translate("private")}
            helperText={translate("private_mode")}
          />
        </div>
        <DialogFooter>
