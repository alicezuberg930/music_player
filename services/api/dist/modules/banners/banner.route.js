...
bannerRouter.post("/banners", middleware_1.JWTMiddleware, upload.fields([{ name: "thumbnail", maxCount: 1 }]), fileValidator, (0, middleware_1.validateDtoHanlder)(create_banner_dto_1.CreateBannerDto), (request, response) => banner_controller_1.default.createBanner(request, response));
