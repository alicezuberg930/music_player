...
class UserService {
    ...
    async signIn(request, response) {
        try {
            ...
            const token = jsonwebtoken_1.default.sign({ id: user.id }, create_env_1.env.JWT_SECRET, { expiresIn: '1d', algorithm: 'HS256' });
    ...
    async signUp(request, response) {
        try {
            ...
            const token = jsonwebtoken_1.default.sign({ id: user[0].id }, create_env_1.env.JWT_SECRET, { expiresIn: '1d', algorithm: 'HS256' });
