...
class PlaylistService {
    ...
    async createPlaylist(request, response) {
        try {
            ...
            if (thumbnailFile) {
                thumbnailUrl = (await (0, cloudinary_file_1.uploadFile)(thumbnailFile, '/playlist', (0, utils_1.createId)()));
            }
            const playlist = {
        ...
        try {
            ...
            if (thumbnailFile) {
                if (myPlaylist.thumbnail.includes('/assets/')) {
                    thumbnail = (await (0, cloudinary_file_1.uploadFile)(thumbnailFile, '/playlist', (0, utils_1.createId)()));
                }
                else {
