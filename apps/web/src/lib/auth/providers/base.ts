...
export class OAuthClient {
    ...
    public createAuthorizationURL(endpoint: string, state: string, scopes: string[]): URL {
    ...
    public async createAuthorizationUrlWithPKCE(
        ...
        const url = this.createAuthorizationURL(endpoint, state, scopes)
    ...
    public async validateAuthorizationCode(
        ...
        if (this.clientSecret)
            request.headers.set('Authorization', `Basic ${this.encodeCredentials(this.clientId, this.clientSecret)}`)
