      ...
      <div className="flex justify-between px-4">
        ...
        <div className="flex flex-1 items-center gap-4 flex-col">
          <div className="flex gap-8 items-center">
            <Tooltip>
              ...
              <TooltipContent>Bật phát ngẫu nhiên</TooltipContent>
            </Tooltip>
            <Button
              size={"icon"}
              variant={"ghost"}
                ...
                <TooltipContent>
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <div>
                      ...
                      <Typography className="m-0 lg:text-xs">
            ...
            <Tooltip>
              <TooltipTrigger
                render={
                  <button
                    ...
                    onClick={() =>
                      setRepeatMode(repeatMode === 2 ? 0 : repeatMode + 1)
                    }
              ...
              <TooltipContent>Phát lại tất cả bài hát</TooltipContent>
            </Tooltip>
          </div>
        ...
        <div className="flex-1 items-center gap-4 hidden md:flex justify-end">
          ...
          <Button
            ...
            size={"lg"}
            onClick={() => dispatch(setShowSidebarRight(!showSideBarRight))}
